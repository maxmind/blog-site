...
[GeoLite databases](https://dev.maxmind.com/geoip/geolite2-free-geolocation-data/)
in 2019.

After careful consideration, taking into account customer feedback, we have
decided against removing latitude and longitude coordinates from the GeoLite
databases. We are in the process of reviewing coordinates used in all of our
GeoLite and GeoIP databases to ensure there is no risk of misuse.

Moving forward, we will still be discontinuing the GeoLite Legacy databases and
will continue to support open source through our GeoLite databases. Please
...
updates on our review of GeoLite database coordinates.
...
_GeoLite databases are free IP geolocation databases comparable to, but less
accurate than, MaxMind's GeoIP databases. Please remember to use the accuracy
