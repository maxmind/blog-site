...
analysis.
[Possible inputs](https://dev.maxmind.com/minfraud/api-documentation/requests/)
include IP address, shipping address, email MD5 hash, and the IIN (Issuer
Identification Number, also commonly referred to as BIN); it's best to provide
as many inputs as possible. The minFraud service then checks these inputs
against a vast history of transaction data and returns the riskScore.
