...
### [](https://github.com/maxmind/mmdb-from-go-blogpost#prerequisites)Prerequisites
...
### [](https://github.com/maxmind/mmdb-from-go-blogpost#acmecorps-data)AcmeCorp's data
...
### [](https://github.com/maxmind/mmdb-from-go-blogpost#the-steps-were-going-to-take)The steps we're going to take
...
### [](https://github.com/maxmind/mmdb-from-go-blogpost#the-code-explained)The code, explained
