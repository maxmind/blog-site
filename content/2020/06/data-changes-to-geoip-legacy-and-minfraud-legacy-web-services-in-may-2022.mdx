...
the [**Retirement of GeoIP Legacy Downloadable Databases in May
...
[here](https://dev.maxmind.com/geoip/geoip2/geoip2-city-country-csv-databases/#CSV_File_Format).
...
| Legacy service                            | Legacy URL                               | Alernate URL (with data changes)                    |
| ----------------------------------------- | ---------------------------------------- | --------------------------------------------------- |
...
please [contact us](https://support.maxmind.com/contact-us/).
