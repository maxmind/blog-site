...
We make our services as easy to use as possible. All of our web services are clearly documented on our [developer website](https://dev.maxmind.com). We also believe in open source. You can follow us on [GitHub](https://github.com/maxmind/), where we publish our client APIs, as well as the spec and creation tools for our new IP database format.

Watch this space! You can also follow us on Twitter as [@maxmind](https://twitter.com/maxmind).
