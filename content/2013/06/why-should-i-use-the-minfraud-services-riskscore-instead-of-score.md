...
[minFraud versions](https://www.maxmind.com/en/accounts/current/minfraud/legacy-version)
and [APIs](https://dev.maxmind.com/minfraud/api-documentation/#client-apis) up
