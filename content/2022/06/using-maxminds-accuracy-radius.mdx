...
date: "2022-06-06"
featuredImage: images/accuracy-radius.png
isFeatured: true
categories:
...
marked.](images/map-with-stores.png)
...
the nearest store from a list of options."](images/flow-chart.png)
...
the northwest, northeast, and south.](images/map-with-point.png)
...
point.](images/map-with-point-and-location.png)
...
geolocation area.](images/map-with-area.png)
...
area.](images/map-with-area-and-location.png)
...
Pittsfield.](images/map-with-area-and-another-location.png)
