...
import the CSV versions of our GeoIP and GeoLite databases into PostgreSQL and
...
You can import GeoIP and GeoLite data into your database in order to more easily
manipulate and transform the data, or join and link the data with other
