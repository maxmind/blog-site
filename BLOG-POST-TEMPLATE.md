...
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `title`       | The **SEO title** of the blog post, contained in double quotes (`""`). Used for the `<title></title>` meta tag, `og:title`, `twitter:title`, and the JSON-LD `headline`. If `heading` is omitted, this is also used as the level 1 header at the top of the post. [Learn more about metadata on the blog.](#metadata)                                                                                        |
| `heading`     | The heading for the blog post, contained in double quotes (`""`). This will be used as the title displayed at the top of the post in a level 1 header and the related-article link text. If this is omitted, then the `title` will be used as the level 1 header and the related-article link text. **Note**: The `<title></title>` meta tag will still be the `title`. This is optional and should only be added if you want the metadata and h1 tag on the page to differ. |
| `description` | The **SEO description** of the post, contained in double quotes (`""`). Used for the meta description tag, `og:description`, `twitter:description`, and the JSON-LD `description`. If omitted, these fall back to the post summary. This is optional but recommended for SEO.                                                                                                                               |
